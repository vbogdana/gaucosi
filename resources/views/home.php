                        ...
                        <div class="overlay" id="overlay">
                            ...
                            <nav id="dl-menu" class="overlay-menu dl-menuwrapper">
                                ...
                                <ul class="heighlight-menu menu-smooth dl-menu">
                                    ...
                                    <li><a href="#events" data-scroll class="scrollTo">DOGAĐAJI</a>

                                    </li>

                                    <li><a href="#about" data-scroll class="scrollTo">O NAMA</a>

                                    </li>

                                    <li><a href="#menu" data-scroll class="scrollTo">KARTA PIĆA</a>
